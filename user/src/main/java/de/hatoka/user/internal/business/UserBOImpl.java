...
public class UserBOImpl implements UserBO
{
    ...
    {
        return UserRef.globalRef(userPO.getGlobalRef());
    }
    ...
    {
        userPO.setEmail(info.geteMail());
        userPO.setFullName(info.getFullName());
        userPO.setFirstName(info.getGivenName());
        userPO.setLastName(info.getFamilyName());
        userPO.setNickName(info.getPreferredUsername());
        LoggerFactory.getLogger(getClass()).info("user info updated {} {} - {} ", info.getGivenName(), info.getFamilyName(), info.geteMail());
        savePO();
    }
}
